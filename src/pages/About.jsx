  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 2, textAlign: 'center', padding: '36px 40px' }}>
          <span style={{
            ...
            background: '#ED7D2B', color: '#3A5A14',
          ...
          <div style={{ width: 40, height: 1, background: '#ED7D2B', opacity: 0.7, margin: '18px auto 0' }} />
        </div>
      </div>
      ...
      <div style={{ padding: '52px 40px 60px', maxWidth: 720, margin: '0 auto', textAlign: 'center' }}>
        ...
        <p style={{ fontFamily: "'Nunito', sans-serif", fontSize: 16, color: '#456D1B', lineHeight: 1.9, marginBottom: 20, fontWeight: 300 }}>
        ...
        <p style={{ fontFamily: "'Nunito', sans-serif", fontSize: 16, color: '#456D1B', lineHeight: 1.9, marginBottom: 44, fontWeight: 300 }}>
          ...
          {[
            ...
            <div key={s.label} style={{
              ...
              <div style={{
                ...
                color: '#D12918', lineHeight: 1,
              }}>{s.num}</div>
              <div style={{
                fontFamily: "'Nunito', sans-serif",
                fontSize: 9, fontWeight: 700, color: '#6B8F3A',
                textTransform: 'uppercase', letterSpacing: '0.10em',
        ...
        {/* Values */}
        <h3 style={{ fontFamily: "'Nunito', sans-serif", fontWeight: 900, fontSize: 26, color: '#3A5A14', marginBottom: 20 }}>
          Our Values
        </h3>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 1, marginBottom: 44, textAlign: 'left', border: '1px solid rgba(209,41,24,0.12)', borderRadius: 16, overflow: 'hidden' }}>
          {values.map((v, i) => (
            <div key={v.title} style={{
              display: 'flex', alignItems: 'center', gap: 20,
              background: '#fff',
              borderBottom: i < values.length - 1 ? '1px solid rgba(209,41,24,0.08)' : 'none',
              padding: '22px 24px',
            }}>
              <div style={{
              ...
              <div>
                <div style={{ fontFamily: "'Nunito', sans-serif", fontWeight: 900, fontSize: 15, fontWeight: 600, color: '#3A5A14', marginBottom: 4 }}>{v.title}</div>
                <div style={{ fontFamily: "'Nunito', sans-serif", fontSize: 13, color: '#6B8F3A', lineHeight: 1.65 }}>{v.desc}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            fontFamily: "'Nunito', sans-serif", fontWeight: 900, fontSize: 130,
          ...
          <p style={{ fontFamily: "'Nunito', sans-serif", fontSize: 13, fontWeight: 700, color: '#ED7D2B', letterSpacing: '0.06em' }}>— Obaa Yaa</p>
        </div>
      </div>
